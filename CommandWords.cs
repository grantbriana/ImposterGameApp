...
namespace ImposterGameApp
{
    public class CommandWords
    {
        ...
        private static Command[] commandArray = { new GoCommand(), new QuitCommand(), new AttackCommand(), new WhereAmICommand(),
                                                  new TalkCommand(), new TakeCommand(), new DropCommand(), new InspectCommand(),
                                                  new BackCommand()};
